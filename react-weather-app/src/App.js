...
import {faTemperatureLow, faTemperatureHigh, faMapMarkedAlt} from "@fortawesome/free-solid-svg-icons"

countries.registerLocale(require('i18n-iso-countries/langs/en.json'))

function App(){
  const [apiData, setApiData] = useState({});
  const [getState, setGetSate] = useState('Irvine, USA');
        ...
        <div className="card mt-3 mx-auto">
          {apiData.main
            ?(<div className="card-body text-center">
              ...
              <p className="h5">
                <FontAwesomeIcon icon={faMapMarkedAlt} className="fas fa-1x mr-2 text-dark"/>{` `}
